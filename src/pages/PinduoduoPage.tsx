...
const PinduoduoPage: React.FC = () => {
  const features = [
    {
      icon: <Globe className="w-12 h-12" />,
      title: "Русский интерфейс",
      description: "Помогаем с переводом и поиском товаров на Pinduoduo"
    },
    {
      icon: <ShoppingBag className="w-12 h-12" />,
      title: "Выгодные цены",
      description: "Прямые поставки от производителей по низким ценам"
    },
    {
        ...
        <section className="bg-gradient-to-r from-[#2C3E50] to-[#3498DB] text-white py-20">
          <div className="max-w-7xl mx-auto px-4 md:px-8 text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Пиндуодуо на русском языке
            </h1>
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Покупайте товары с Pinduoduo через надежного посредника. Мы поможем с выбором товаров,
              переводом, оформлением заказа и доставкой в Россию.
            </p>
            <a 
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <h2 className="text-3xl font-bold text-center mb-12 text-[#2C3E50]">
              Преимущества покупок на Pinduoduo с нами
            </h2>
